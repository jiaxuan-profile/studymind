// src/components/view-session/SessionNavigationControls.tsx
    ...
    <div className="mb-8 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg flex justify-between items-center">
      ...
      {isLastQuestion ? (
        ...
        <button
          ...
          className="inline-flex items-center px-6 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-secondary hover:bg-secondary-dark transition-colors"
        >
          Next
