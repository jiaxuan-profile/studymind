...
interface SingleFlashcardDisplayProps {
  ...
  heightClassName?: string; // e.g., "h-64" or "h-96"
  isReadOnlyDemo?: boolean; // To disable response buttons or show demo toast
  addToast?: (message: string, type: 'success' | 'error' | 'info' | 'warning') => void; // Optional for demo mode
}
